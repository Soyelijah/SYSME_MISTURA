...
include "./conn.php";
	...
	if (mysql_num_rows($result) == 0)
		...
		$salida = $salida.'<span class="btncatcat">Volver</span><br/>';
	...
	while ($row = mysql_fetch_array($result))
		{
		$salida = $salida.'<div class="botonsub">';
		$salida = $salida.'<a class="btncatcat" id="link9'.$row['id_tipo_comg'].'" href="javascript:void(null);" onclick="showsubcategorias(\''.$row['id_tipo_comg'].'\',0); showproductos(\''.$row['id_tipo_comg'].'\',0);">';
